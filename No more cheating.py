...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setText("")
        self.gif=QMovie("tumblr_p0168gtRdI1runoqyo34_540.gif")
        ...
        font.setWeight(75)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("large-transformed__1_-removebg-preview.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Smart Classes"))
        self.label.setToolTip(_translate("MainWindow", "<html><head/><body><p><img src=\"tumblr_p0168gtRdI1runoqyo34_540.gif\"/></p></body></html>"))
        self.label_2.setText(_translate("MainWindow", "Smart Classes(No more cheating)"))
